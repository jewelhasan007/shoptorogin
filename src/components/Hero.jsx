...
const Hero = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    ...
    <div className="sm:w-full sm:text-center md:text-left md:w-2/3 ">
      <h1 className=" sm:w-full text-5xl font-bold mb-7 w-2/3">Books to freshen up your bookshelf</h1>
